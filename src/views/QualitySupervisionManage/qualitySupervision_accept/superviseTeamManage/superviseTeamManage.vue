<template>
    <div class="superviseTeamManage-container">
        ...
        <vAddSuperviseTeamPerson
                :value="modal_addSuperviseTeamPerson"
                @modal-callback="modal_addSuperviseTeamPerson_callback"
                @close="modal_addSuperviseTeamPerson_close"></vAddSuperviseTeamPerson>
        ...
        data() {
            return {
                tableColumns: [
                    ...
                    { title: '操作时间', width: 110, align: 'center', key: 'insTime' },
                ...
                tableData:[
                    ...
                    },
                    {
                        ...
                        userId: '02',          // 人员ID
                        name: '林科员',            // 人员名称
                        projectName: '霍邱县S310霍邱至众兴路一级公路改建工程2',
                        monitorType: 'member',     // 人员类型
                        monitorTypeLabel: '小组成员',
                        createBy: '管理员',        // 操作用户
                        insTime: '2018-08-01'          // 操作时间
                    }
                ],
                tableLoading: false,
                modal_addSuperviseTeamPerson: false
            };
        },
        mounted() {},
        methods: {
            modal_addStep_open() {
                this.modal_addSuperviseTeamPerson = true;
            },
            modal_addSuperviseTeamPerson_callback() {
                this.getData();
            },
            modal_addSuperviseTeamPerson_close(val) {
                this.modal_addSuperviseTeamPerson = val;
            },
            getData() {
