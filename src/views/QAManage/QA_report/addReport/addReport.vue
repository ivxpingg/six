    ...
    <div class="addReport-container">
        <Modal v-model="modalValue" title="上传报表">
            <Form ref="form"
                ...
                <FormItem label="报表年度" prop="year">
                    <DatePicker :value="formData.year" type="year" placeholder="请选择年份" style="width: 200px" @on-change="onChange_year"></DatePicker>
                </FormItem>
                <FormItem label="备注：">
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    year: [{ required: true, message: '报表年度不能为空！', trigger: 'blur' }],
        ...
        methods: {
            ...
            fileUploadSuccess(response, file, fileList) {
                ...
                if (this.formData.name.trim() === '') {
                    this.formData.name = response.data.fileName;
                }
                this.$refs.form.validateField('fileId');
            },
