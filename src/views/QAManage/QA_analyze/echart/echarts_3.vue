<template>
    <div class="echarts_3-container" ref="chart">
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                this.$http({
                    method: 'get',
                    url: '/dataAnalysis/projectPassRate',
                    params: {
                        year: this.year
                    }
                }).then(res => {
            ...
            resetOption(data) {
                ...
                for (let key in data) {
                    ...
                    data[key].forEach(val => {
                        ...
                        if (myOPtion.xAxis[0].data.indexOf(val.projectName) === -1) {
                            myOPtion.xAxis[0].data.push(val.projectName);
                        }
                ...
                for (let key in data) {
                    ...
                    data[key].forEach(val => {
                        let idx_data = myOPtion.xAxis[0].data.indexOf(val.projectName);
