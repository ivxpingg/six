...
<script>
    import vMap from './map/map.vue';
    import vLineCharts from './chart/lineChart';
    import vBarCharts from './chart/barChart';
    import vRadarChart from  './chart/radarChart';
