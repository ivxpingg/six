...
public class ProcessStepController {
   ...
   // @RequiresPermissions("sys:dict:view")
    ...
    public String delete(@RequestParam(required=true) String processStepId) {
        boolean result = processStepService.deleteById(processStepId);
        if(!result){
    ...
    public String update(@RequestParam String processStepId) {
        return JsonUtil.getSuccJson(processStepService.selectById(processStepId));
    }
